...
[F6 검증된 외부 결정](29_verified_external_decisions.md)은 작성자 앵커와 정확한 대상에 결속된
외부 서명에서만 긍정을 만든다. 업무·초기 결합·교체 결합은 별개이며 만료·철회가 과거 기록을
덮어쓰지 않는다. 기본 제품은 앵커가 없어 승인하지 못하고 실제 운영 영역 연결은 미지원이다.
